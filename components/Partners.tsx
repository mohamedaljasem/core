            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div>
                ...
                <p className="text-lg md:text-xl leading-relaxed mb-6">
                  "التعاون مع كور كونسيبت كان تجربة تحويلية حقيقية. البرامج التدريبية المصممة خصيصاً لاحتياجاتنا أحدثت فرقاً ملموساً في أداء فريقنا. 
                  الاحترافية العالية والفهم العميق لبيئة الأعمال السعودية جعلهم الشريك المثالي لنا."
                </p>
